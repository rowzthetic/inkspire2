...
export default function ForgotPassword() {
  ...
  const handleRequestOtp = async (e) => {
    ...
    try {
      const response = await fetch('https://inkspire2.onrender.com/api/auth/password-reset/', {
        method: 'POST',
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch('https://inkspire2.onrender.com/api/auth/password-reset/confirm/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          email,
